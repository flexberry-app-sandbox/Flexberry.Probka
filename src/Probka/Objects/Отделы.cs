    ...
    public class Отделы : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ОтделыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОтделыE", typeof(IIS.Probka.Отделы));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ОтделыL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОтделыL", typeof(IIS.Probka.Отделы));
                }
            }
        }
    }
